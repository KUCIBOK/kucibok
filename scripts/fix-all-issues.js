...
/**
 * CRITICAL FIX: Correct all 53 orphaned artworks
 */
...
const CORRECTIONS = [
  ...
  { id: '90d97764-471c-47c7-ae97-fd2996d7cb7e', artist_id: '3e469ac2-5cf1-498a-9e20-f8f0312be8f0' },
...
async function fixAll() {
  console.log("🔧 FIXING 53 ARTWORKS...\n");
  ...
  for (const correction of CORRECTIONS) {
    try {
      const { error } = await supabase
        .from("artworks")
        .update({ artist_id: correction.artist_id })
        .eq("id", correction.id);
  ...
  console.log("\n🔒 Database is now fully corrected!");
}
